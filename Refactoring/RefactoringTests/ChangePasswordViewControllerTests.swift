...
final class ChangePasswordViewControllerTests: XCTestCase {
    ...
    func test_oldPasswordTextField_인스팩터_설정이_제대로되어있는지() {
    ...
    func test_newPasswordTextField_인스팩터_설정이_제대로되어있는지() {
    ...
    func test_confirmPasswordTextField_인스팩터_설정이_제대로되어있는지() {
    ...
    func test_tappingCancel이_빌생했을때_withFocusOnOldPassword가_반응하고_리사인되는지() {
    ...
    func test_tappingCancel_발생했을_때_withFocusOnNewPassword가_반응하고_리사인되는지() {
